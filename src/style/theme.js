export default {
  ...
  global: {
    fieldset:
      'ml-4 max-w-md border border-gray-500 dark:border-gray-200 rounded px-2 pb-1 formkit-invalid:border-red-500 formkit-complete:border-green-300',
    ...
    label: 'block mb-1 ml-4 font-bold text-sm text-blue-600 dark:text-blue-300',
    legend: 'font-bold text-sm text-blue-300 dark:text-blue-500 mb-5',
    loaderIcon: 'inline-flex items-center w-4 text-gray-600 animate-spin',
    message: 'text-red-500 ml-4 mb-1 text-xs',
  ...
  'family:box': {
    ...
    label: '$reset text-sm dark:text-blue-500 text-gray-700 mt-1 select-none',
  ...
  'family:text': {
    inner:
      'ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1 ml-4 mr-4 formkit-invalid:bg-red-200 formkit-complete:bg-green-100',
    input:
      'w-full px-3 py-2 border-none text-base dark:text-gray-400 text-gray-700 placeholder-gray-400'
  },
  'family:date': {
    inner:
  ...
  radio2: {
    decorator:
      '$reset formkit-decorator block relative h-5 w-5 ml-2 mr-1 text-transparent peer-checked:text-blue-500',
    fieldset:
      '$reset formkit-fieldset bg-white rounded px-2 pb-1 border formkit-invalid:border-red-500',
    label: '$reset formkit-label py-2 pr-4',
    options: 'flex flex-wrap gap-1',
    wrapper:
      '$reset formkit-wrapper flex items-center rounded-lg border border-gray-300 data-checked:border-blue-500 hover:border-blue-500',
  },
  range: {
  ...
  select: {
    inner:
      'ml-4 mr-4 flex relative items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500 formkit-invalid:bg-red-200 formkit-complete:bg-green-100',
    input:
