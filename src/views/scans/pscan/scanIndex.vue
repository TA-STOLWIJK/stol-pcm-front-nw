...
import ReportFormal from '@/presentations/scan/pscan/reportForm.vue'
import ReportInformal from '@/presentations/scan/pscan/reportInform.vue'
...
import editScan from '@/views/scans/pscan/editScan.vue'
...
const resetData = async () => {
  useConfirmBeforeDelete(
    async () => {
      await scanStore.setDefaultP(route.params.id)
      await scanStore.getScanP(route.params.id)
    },
