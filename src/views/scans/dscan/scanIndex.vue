...
import ReportFormal from '@/presentations/scan/dscan/reportFormal.vue'
import ReportInformal from '@/presentations/scan/dscan/reportInformal.vue'
...
import editScan from '@/views/scans/dscan/editScan.vue'
...
const resetData = async () => {
  useConfirmBeforeDelete(
    async () => {
      await scanStore.setDefaultD(route.params.id)
...
<template>
  <PageDefaultLayoutTwo>
    ...
    <HeaderOne
      >QuickScan sturen op resultaat {{ clientSingleStore.first_name_client }}
