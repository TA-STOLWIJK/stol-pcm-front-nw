...
import ReportFormal from '@/presentations/scan/ascan/reportFormal.vue'
import ReportInformal from '@/presentations/scan/ascan/reportInformal.vue'
...
import editScan from '@/views/scans/ascan/editScan.vue'
...
const resetData = async () => {
  useConfirmBeforeDelete(
    async () => {
      await scanStore.setDefaultA(route.params.id)
...
<template>
  <PageDefaultLayoutTwo>
    ...
    <HeaderOne id="scroll"
      >QuickScan Noodplan voor {{ clientSingleStore.first_name_client }}
