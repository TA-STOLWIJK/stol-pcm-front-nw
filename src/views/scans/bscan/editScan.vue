  ...
  >
    <div role="alert" class="container mx-auto w-11/12">
      ...
      >
        ...
        <div class="grid grid-cols-4 gap-4">
          <div>
            <HeaderTwo>Gebruik App</HeaderTwo>
            <TextOne> Wat is de aanbieding voor het gebruik van de app? (bedrag in euro) </TextOne>
          </div>
          <FormKit
            type="text"
            label="Bedrag App"
        ...
        <div class="grid grid-cols-4 gap-4">
          <div>
            <HeaderTwo>Bijeenkomsten</HeaderTwo>
            <TextOne> Wat is uw aanbieding voor de familiebijeenkomsten? (bedrag in euro) </TextOne>
          </div>
          <FormKit
            type="text"
            label="Bedrag bijeenkomsten"
            validation="required"
            validation-visibility="dirty"
