...
import ReportFormal from '@/presentations/scan/tscan/reportForm.vue'
import ReportInformal from '@/presentations/scan/tscan/reportInform.vue'
...
import editScan from '@/views/scans/tscan/editScan.vue'
...
const resetData = async () => {
  useConfirmBeforeDelete(
    async () => {
      await scanStore.setDefaultT(route.params.id)
...
<template>
  <PageDefaultLayoutTwo>
    ...
    <HeaderOne
      >QuickScan duurzaamheid voor {{ clientSingleStore.first_name_client }}
