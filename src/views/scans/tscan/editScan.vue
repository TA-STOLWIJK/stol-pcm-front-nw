...
const saveExisting = async () => {
  ...
  await scanStore.changeScanT()
  if (scanStore.error === null) {
    // await teamSingleStore.setDefault()
    await scanStore.getScanT(route.params.id)
    ...
    <div role="alert" class="container mx-auto w-11/12">
      ...
      >
        ...
        <div class="grid grid-cols-1">
          <FormKit type="checkbox" label="Bedrijfspand" v-model="scanStore.scanData.vis_b" />
          <FormKit
            type="checkbox"
            label="Energiebesparingsplicht"
            v-model="scanStore.scanData.vis_c"
          />
          <FormKit
            type="checkbox"
            label="Mobiliteit"
            v-model="scanStore.scanData.vis_d"
          />
          <FormKit
            type="checkbox"
            label="Duurzame inzetbaarheid"
            v-model="scanStore.scanData.vis_e"
          />
          <FormKit
            type="checkbox"
            label="Rapportage"
            v-model="scanStore.scanData.vis_f"
          />
        </div>
        <div class="grid grid-cols-1">
          <FormKit type="checkbox" label="Bedrijfspand" v-model="scanStore.scanData.vis_a" />
        </div>
