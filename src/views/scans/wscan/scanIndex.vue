...
import editScan from '@/views/scans/wscan/editScan.vue'
...
const resetData = async () => {
  useConfirmBeforeDelete(
    async () => {
      await scanStore.setDefaultW(route.params.id)
...
<template>
  <PageDefaultLayoutTwo>
    ...
    <HeaderOne
      >QuickScan werkgevers voor {{ clientSingleStore.first_name_client }}
