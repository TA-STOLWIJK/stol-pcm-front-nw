...
import SheetText from '@/json/scan/tscanInf.json'
import defaultSlideAll from '@/mixin/defaultSlideAll'
import defaultSlideT from '@/mixin/defaultSlideT'
...
export default {
  ...
  mixins: [defaultSlideT, defaultSlideAll],
  data() {
    return {
  ...
  methods: {
    ...
    createPowerPoint() {
      ...
      pres.defineSlideMaster(this.dataScanT)
      pres.defineSlideMaster(this.dataScanT_Photo)
      pres.defineSlideMaster(this.dataStart)
      pres.defineSlideMaster(this.finalSlide)

      let slideStart = pres.addSlide('FIRST_SLIDE_')
      slideStart.addText(
        [{ text: 'Duurzaamheid', options: this.fontFirstPageHeader }],
      ...
      let slideIntroA = pres.addSlide('T_SLIDE_Photo')
      slideIntroA.addText(
        [
          {
      ...
      let slideIntroB = pres.addSlide('T_SLIDE_Photo')
      slideIntroB.addText(
        [
          {
      ...
      let slideQuesA = pres.addSlide('T_SLIDE_Photo')
      slideQuesA.addImage({
      ...
      let slideQuesB = pres.addSlide('T_SLIDE_Photo')
      slideQuesB.addImage({
      ...
      let slideQuesC = pres.addSlide('T_SLIDE_Photo')
      slideQuesC.addImage({
      ...
      let slideQuesD = pres.addSlide('T_SLIDE_Photo')
      slideQuesD.addImage({
      ...
      let slideQuesE = pres.addSlide('T_SLIDE_Photo')
      slideQuesE.addImage({
      ...
      let slideQuesF = pres.addSlide('T_SLIDE_Photo')
      slideQuesF.addImage({
      ...
      let slideQuesG = pres.addSlide('T_SLIDE_Photo')
      slideQuesG.addImage({
