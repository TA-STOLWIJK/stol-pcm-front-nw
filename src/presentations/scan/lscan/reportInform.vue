...
import defaultSlideB from "@/mixin/defaultSlideL";
...
import SheetText from "@/json/scan/lscanInf.json";
import pptxgen from 'pptxgenjs'
import { toast } from "vue3-toastify";
import InformalButton from "@/components/button/InformalButton.vue";
export default {
  name: "reportLscan", components: { InformalButton },
  ...
  methods: {
    ...
    createPowerPoint() {
      ...
      pres.defineSlideMaster(this.dataScanL);
      pres.defineSlideMaster(this.dataScanL_Photo);
      ...
      let slideIntroA = pres.addSlide("L_SLIDE_Photo");
      slideIntroA.addText(
        [
          {
      ...
      let slideIntroB = pres.addSlide("L_SLIDE_Photo");
      slideIntroB.addText(
        [
          {
      ...
      let slideQuesA = pres.addSlide("L_SLIDE");
      slideQuesA.addText(
      ...
      let slideQuesB = pres.addSlide("L_SLIDE");
      slideQuesB.addText(
      ...
      let slideQuesC = pres.addSlide("L_SLIDE");
      slideQuesC.addText(
      ...
      rowC.push([
        { text: this.sheetText["ques-c"].text_c + this.dataScan.sl_b },
      ]);
      rowC.push([{ text: "" }]);
      ...
      let slideQuesD = pres.addSlide("L_SLIDE");
      slideQuesD.addText(
      ...
      let slideQuesE = pres.addSlide("L_SLIDE");
      slideQuesE.addText(
      ...
      rowE.push([
        { text: this.sheetText["ques-e"].text_c + this.dataScan.sl_c },
      ]);
      rowE.push([{ text: "" }]);
      ...
      let slideQuesF = pres.addSlide("L_SLIDE");
      slideQuesF.addText(
      ...
      let slideQuesG = pres.addSlide("L_SLIDE");
      slideQuesG.addText(
      ...
      let slidePropA = pres.addSlide("L_SLIDE_Photo");
      slidePropA.addText(
      ...
      let slidePropB = pres.addSlide("L_SLIDE_Photo");
      slidePropB.addText(
      ...
      let slidePropC = pres.addSlide("L_SLIDE_Photo");
      slidePropC.addText(
